...
import { classOneStudentsInfo, classThreeStudentsInfo, classTwoStudentsInfo } from '../../data';
            ...
            <div className="max-w-[848px] mx-auto overflow-auto">
                <table className="w-full">
                    ...
                    <tbody>
                        ...
                        {classOneStudentsInfo.map((student)=>(
                        ...
                        <tr className="bg-white/5">
                            <td className="p-5 text-sm md:text-xl col-span-4" colSpan={4}>
                                Class Two
                            </td>
                        </tr>

                            {classTwoStudentsInfo.map((student)=>(
                                <Fragment key={student.Id}>
                                     <tr className="border-b border-[#7ECEB529]">
                            <td className="p-5 text-sm md:text-xl">{student.Id}</td>
                            <td className="p-5 text-sm md:text-xl">
                        ...
                        <tr className="bg-white/5">
                            <td className="p-5 text-sm md:text-xl col-span-full" colSpan={4}>
                                Class Three
                            </td>
                        </tr>

                        {classThreeStudentsInfo.map((student)=>(
                            <Fragment key={student.Id}>
